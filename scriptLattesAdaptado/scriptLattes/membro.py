...
class Membro:
	...
	def carregarDadosCVLattes(self):
		...
		self.listaProgramaDeComputador		  = parser.listaProgramaDeComputador
		self.listaMarcaRegistrada			  = parser.listaMarcaRegistrada
		self.listaTopografiaDeCircuitoIntegrado = parser.listaTopografiaDeCircuitoIntegrado 		
	...
	def filtrarItemsPorPeriodo(self):
		...
		self.listaProgramaDeComputador     		   = self.filtrarItems(self.listaProgramaDeComputador)
		self.listaMarcaRegistrada       		   = self.filtrarItems(self.listaMarcaRegistrada)
		self.listaTopografiaDeCircuitoIntegrado    = self.filtrarItems(self.listaTopografiaDeCircuitoIntegrado)
	...
	def estaDentroDoPeriodo(self, objeto):
		if objeto.__module__=='projetoDePesquisa':
			...
			if objeto.anoInicio.isdigit() and objeto.anoConclusao.isdigit():
	...
	def __str__(self):
		...
		if verbose:
			...
			s += "\n"
			for pub in self.listaProgramaDeComputador:
				s += pub.__str__()

			s += "\n"
			for pub in self.listaMarcaRegistrada:
				s += pub.__str__()

			s += "\n"
			for pub in self.listaTopografiaDeCircuitoIntegrado:
				s += pub.__str__()
			...
			s += "\n- Programa de Computador                      : " + str(len(self.listaProgramaDeComputador))
			s += "\n- Marca Registrada                            : " + str(len(self.listaMarcaRegistrada))
			s += "\n- Topografia de Circuito Integrado            : " + str(len(self.listaTopografiaDeCircuitoIntegrado))
			s += "\n- Orientações em andamento"
