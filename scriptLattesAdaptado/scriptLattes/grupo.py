...
class Grupo:
	...
	def gerarGraficosDeBarras(self):
		...
		gBarra.criarGrafico(self.compilador.listaCompletaPatente, 'PR0', 'Numero de patetes e registros')
		gBarra.criarGrafico(self.compilador.listaCompletaProgramaDeComputador, 'PR1', 'Numero de patetes e registros')
		gBarra.criarGrafico(self.compilador.listaCompletaMarcaRegistrada, 'PR2', 'Numero de patetes e registros')
		gBarra.criarGrafico(self.compilador.listaCompletaTopografiaDeCircuitoIntegrado, 'PR3', 'Numero de patetes e registros')
		...
		gBarra.criarGrafico(self.compilador.listaCompletaPR, 'PR', 'Numero de patentes e registros')
	...
	def carregarParametrosPadrao(self):
		...
		self.listaDeParametros.append(['relatorio-incluir_programa_de_computador', 'sim'])
		self.listaDeParametros.append(['relatorio-incluir_marca_registrada', 'sim'])
		self.listaDeParametros.append(['relatorio-incluir_topografia_de_circuito_integrado', 'sim'])		
		...
		self.listaDeParametros.append(['grafo-incluir_programa_de_computador', 'sim'])
		self.listaDeParametros.append(['grafo-incluir_marca_registrada', 'sim'])
		self.listaDeParametros.append(['grafo-incluir_topografia_de_circuito_integrado', 'sim'])
