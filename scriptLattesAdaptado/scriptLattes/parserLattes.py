...
from patente import *
from programaDeComputador import *
from marcaRegistrada import *
from topografiaDeCircuitoIntegrado import *
...
class ParserLattes(HTMLParser):
	...
	achouPatente = None
	achouProgramaDeComputador = None
	achouCultivarProtegida = None
	achouCultivarRegistrada = None
	achouDesenhoIndustrial = None
	achouMarcaRegistrada = None
	achouTopografiaDeCircuitoIntegrado = None
	...
	listaPatente = []
	listaProgramaDeComputador = []
	listaMarcaRegistrada = []
	listaTopografiaDeCircuitoIntegrado = []
	...
	def __init__(self, idMembro, cvLattesHTML):
		...
		self.listaPatente = []
		self.listaProgramaDeComputador = []
		self.listaMarcaRegistrada = []
		self.listaTopografiaDeCircuitoIntegrado = []
				...
				if self.salvarParte2:
					...
					if self.achouPatenteRegistro:
						if self.achouPatente:
							...
							self.relevante = 0
						if self.achouProgramaDeComputador:
							iessimoItem = ProgramaDeComputador(self.idMembro, self.partesDoItem, self.relevante)
							self.listaProgramaDeComputador.append(iessimoItem)
							self.relevante = 0
						if self.achouMarcaRegistrada:
							iessimoItem = MarcaRegistrada(self.idMembro, self.partesDoItem, self.relevante)
							self.listaMarcaRegistrada.append(iessimoItem)
							self.relevante = 0
						if self.achouTopografiaDeCircuitoIntegrado:
							iessimoItem = TopografiaDeCircuitoIntegrado(self.idMembro, self.partesDoItem, self.relevante)
							self.listaTopografiaDeCircuitoIntegrado.append(iessimoItem)
							self.relevante = 0
	...
	def handle_data(self, dado):
		...
		if self.achouPatenteRegistro:
			if u'Patente'==dado:
				self.salvarItem = 1			
				self.achouPatente = 1
				self.achouProgramaDeComputador = 0
				self.achouCultivarProtegida = 0
				self.achouCultivarRegistrada = 0
				self.achouDesenhoIndustrial = 0
				self.achouMarcaRegistrada = 0
				self.achouTopografiaDeCircuitoIntegrado = 0
			elif u'Programa de computador'==dado:
				self.salvarItem = 1			
				self.achouPatente = 0
				self.achouProgramaDeComputador = 1
				self.achouCultivarProtegida = 0
				self.achouCultivarRegistrada = 0
				self.achouDesenhoIndustrial = 0
				self.achouMarcaRegistrada = 0
				self.achouTopografiaDeCircuitoIntegrado = 0
			elif u'Cultivar protegida'==dado:
				self.salvarItem = 1			
				self.achouPatente = 0
				self.achouProgramaDeComputador = 0
				self.achouCultivarProtegida = 1
				self.achouCultivarRegistrada = 0
				self.achouDesenhoIndustrial = 0
				self.achouMarcaRegistrada = 0
				self.achouTopografiaDeCircuitoIntegrado = 0
			elif u'Cultivar registrada'==dado:
				self.salvarItem = 1			
				self.achouPatente = 0
				self.achouProgramaDeComputador = 0
				self.achouCultivarProtegida = 0
				self.achouCultivarRegistrada = 1
				self.achouDesenhoIndustrial = 0
				self.achouMarcaRegistrada = 0
				self.achouTopografiaDeCircuitoIntegrado = 0
			elif u'Desenho industrial'==dado:
				self.salvarItem = 1			
				self.achouPatente = 0
				self.achouProgramaDeComputador = 0
				self.achouCultivarProtegida = 0
				...
				self.achouCultivarRegistrada = 0
				self.achouDesenhoIndustrial = 0
				self.achouMarcaRegistrada = 1
				self.achouTopografiaDeCircuitoIntegrado = 0
			elif u'Topografia de circuito integrado'==dado:
				self.salvarItem = 1			
				self.achouPatente = 0
				self.achouProgramaDeComputador = 0
				self.achouCultivarProtegida = 0
				...
				self.achouDesenhoIndustrial = 0
				self.achouMarcaRegistrada = 0
				self.achouTopografiaDeCircuitoIntegrado = 1
		...
		if self.achouProducoes:
			if u'Produção bibliográfica'==dado:
				...
				self.achouProducaoTecnica = 0
				self.achouProducaoArtisticaCultural= 0
			elif u'Produção técnica'==dado:
				self.achouProducaoEmCTA = 0
				self.achouProducaoTecnica = 1
				self.achouProducaoArtisticaCultural= 0
			elif u'Produção artística/cultural'==dado:
				self.achouProducaoEmCTA = 0
				self.achouProducaoTecnica = 0
				self.achouProducaoArtisticaCultural= 1
			
			elif u'Demais trabalhos'==dado:
				self.salvarItem = 0
				self.achouProducaoEmCTA = 0
				self.achouProducaoTecnica = 0
				self.achouProducaoArtisticaCultural= 0
			...
			if self.achouProducaoEmCTA:
				if u'Artigos completos publicados em periódicos'==dado:
				...
				elif u'Livros publicados/organizados ou edições'==dado:
					self.salvarItem = 1
					...
					self.achouApresentacaoDeTrabalho = 0
					self.achouOutroTipoDeProducaoBibliografica = 0
				elif u'Capítulos de livros publicados'==dado:
					self.salvarItem = 1
					self.achouArtigoEmPeriodico = 0
					self.achouLivroPublicado = 0
					...
					self.achouApresentacaoDeTrabalho = 0
					self.achouOutroTipoDeProducaoBibliografica = 0
				elif u'Textos em jornais de notícias/revistas'==dado:
					self.salvarItem = 1
					self.achouArtigoEmPeriodico = 0
					self.achouLivroPublicado = 0
					self.achouCapituloDeLivroPublicado = 0
					...
					self.achouApresentacaoDeTrabalho = 0
					self.achouOutroTipoDeProducaoBibliografica = 0
				elif u'Trabalhos completos publicados em anais de congressos'==dado:
					self.salvarItem = 1
					self.achouArtigoEmPeriodico = 0
					self.achouLivroPublicado = 0
					self.achouCapituloDeLivroPublicado = 0
					...
					self.achouApresentacaoDeTrabalho = 0
					self.achouOutroTipoDeProducaoBibliografica = 0
				elif u'Resumos expandidos publicados em anais de congressos'==dado:
					self.salvarItem = 1
					self.achouArtigoEmPeriodico = 0
					self.achouLivroPublicado = 0
					self.achouCapituloDeLivroPublicado = 0
					...
					self.achouApresentacaoDeTrabalho = 0
					self.achouOutroTipoDeProducaoBibliografica = 0
				elif u'Resumos publicados em anais de congressos' in dado:
					self.salvarItem = 1
					self.achouArtigoEmPeriodico = 0
					self.achouLivroPublicado = 0
					self.achouCapituloDeLivroPublicado = 0
					...
					self.achouApresentacaoDeTrabalho = 0
					self.achouOutroTipoDeProducaoBibliografica = 0
				elif u'Artigos aceitos para publicação'==dado:
					self.salvarItem = 1
					self.achouArtigoEmPeriodico = 0
					self.achouLivroPublicado = 0
					self.achouCapituloDeLivroPublicado = 0
					...
					self.achouApresentacaoDeTrabalho = 0
					self.achouOutroTipoDeProducaoBibliografica = 0
				elif u'Apresentações de Trabalho'==dado:
					self.salvarItem = 1
					self.achouArtigoEmPeriodico = 0
					self.achouLivroPublicado = 0
					self.achouCapituloDeLivroPublicado = 0
					...
					self.achouOutroTipoDeProducaoBibliografica = 0
				elif u'Outras produções bibliográficas'==dado:
			...
			if self.achouProducaoTecnica:
				...
				if u'Programas de computador com registro'==dado:
				...
				elif u'Programas de computador sem registro'==dado:
					self.salvarItem = 1
					...
					self.achouTrabalhoTecnico = 0
					self.achouOutroTipoDeProducaoTecnica = 0
				elif u'Produtos tecnológicos'==dado:
					self.salvarItem = 1
					self.achouSoftwareComPatente = 0
					self.achouSoftwareSemPatente = 0
					...
					self.achouTrabalhoTecnico = 0
					self.achouOutroTipoDeProducaoTecnica = 0
				elif u'Processos ou técnicas'==dado:
					self.salvarItem = 1
					self.achouSoftwareComPatente = 0
					self.achouSoftwareSemPatente = 0
					self.achouProdutoTecnologico = 0
					...
					self.achouTrabalhoTecnico = 0
					self.achouOutroTipoDeProducaoTecnica = 0
				elif u'Trabalhos técnicos'==dado:
					self.salvarItem = 1
					self.achouSoftwareComPatente = 0
					self.achouSoftwareSemPatente = 0
					self.achouProdutoTecnologico = 0
					...
					self.achouOutroTipoDeProducaoTecnica = 0
				elif u'Demais tipos de produção técnica'==dado:
					self.salvarItem = 1
					self.achouSoftwareComPatente = 0
					self.achouSoftwareSemPatente = 0
					self.achouProdutoTecnologico = 0
				...
				elif u'Entrevistas, mesas redondas, programas e comentários na mídia'==dado:
					self.salvarItem = 1
					self.achouSoftwareComPatente = 0
					self.achouSoftwareSemPatente = 0
					self.achouProdutoTecnologico = 0
